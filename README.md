...
[![Build Status](https://travis-ci.org/zuusio/api.svg?branch=master)](https://travis-ci.org/zuusio/api)
...
6. If you did everything correct, https://zuusio.github.io/api/ will lead to your new docs
...
- Documentation(ReDoc): https://zuusio.github.io/api/
- SwaggerUI: https://zuusio.github.io/api/swagger-ui/
- Look full spec:
    + JSON https://zuusio.github.io/api/swagger.json
    + YAML https://zuusio.github.io/api/swagger.yaml
- Preview spec version for branch `[branch]`: https://zuusio.github.io/api/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://zuusio.github.io/api/ with url from the message: `Server started <url>`
